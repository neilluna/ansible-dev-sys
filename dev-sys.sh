...
[ ! -z "${called_from_vagrant_dev_sys}" ] && echo_color ${cyan} "Continuing from vagrant-dev-sys ..."
[ ! -z "${called_from_self_update}" ] && echo_color ${cyan} "Continuing from dev-sys self update ..."
